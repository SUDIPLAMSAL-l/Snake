...
public class GamePanel extends JPanel implements ActionListener{
    ...
    public void draw(Graphics g) {
    	...
    	*/
    	...
    	for(int i = 0; i< bodyParts; i++) {
    	 ...
    	 g.drawString("score: "+appleEaten, (SCREEN_WIDTH - matrics.stringWidth("Score: "+appleEaten)), g.getFont().getSize());
    	}
    	else {
    		gameOVer(g);
    	}
    ...
    public void move() {
     ...
     public void checkCollisions() {
    	 ...
    	 //check if hand touches right border
    	 if(x[0] > SCREEN_WIDTH) {
    		 running = false; 
    	 }
    	 //check if hand touches top border
    	 if(y[0] < 0) {
    		 running = false;
    	 }
    	//check if hand touches top border
     ...
     public void gameOVer(Graphics g) {
    	...
    	//Restart button
    	 ...
    	 FontMetrics matrics3 = getFontMetrics(g.getFont());
    	 g.drawString("Space to Restart", 430, 380);
